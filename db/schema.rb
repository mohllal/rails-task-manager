...
ActiveRecord::Schema[7.0].define(version: 2024_11_15_163623) do
  ...
  create_table "task_user_assignments", charset: "utf8mb4", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["task_id", "user_id"], name: "index_task_user_assignments_on_task_id_and_user_id"
    t.index ["task_id"], name: "index_task_user_assignments_on_task_id"
    t.index ["user_id", "task_id"], name: "index_task_user_assignments_on_user_id_and_task_id"
